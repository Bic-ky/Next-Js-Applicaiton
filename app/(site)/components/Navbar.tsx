...
const navigation: NavItem[] = [
  { name: "Home", href: "/" },
  {
    ...
    dropdown: [
      ...
      { name: "Weight Loss Programs", href: "/services/weight-management" },
      { name: "Erectile Dysfunction Programs", href: "/services/mens-health" },
      { name: "Accident and Injury Treatment", href: "/services/injury-treatment" },
      { name: "HRT(Hormone Replacement Therapy)", href: "/services/hormone-therapy" },
    ],
  },
