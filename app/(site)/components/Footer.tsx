...
const footerNavigation = {
  services: [
    { name: "Drug Rehabilitation", href: "#" },
    { name: "Weight Loss Programs", href: "#" },
    { name: "Erectile Dysfunction Treatment", href: "#" },
    { name: "Accident Injury", href: "#" },
    { name: "HRT (Hormone Replacement Therapy)", href: "#" },
  ],
  company: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              ...
              expertise, and cutting-edge technology since 1985.
            </p>
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">(419) 535-3214</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg
                  className="w-5 h-5 text-teal-400"
                ...
                <span className="text-gray-300"> reynoldsclinic@gmail.com</span>
              </div>
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          ...
          <div className="mt-6 p-4 bg-red-900/20 border border-red-800/30 rounded-lg">
            <p className="text-red-200 text-sm text-center">
              <strong>Emergency:</strong> For life-threatening emergencies, call
              911 immediately. For urgent medical concerns, call our 24/7
              hotline: (555) URGENT-1
            </p>
          </div>
        </div>
      </div>
