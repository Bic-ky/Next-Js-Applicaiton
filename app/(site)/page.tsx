...
const testimonials = [
  {
    ...
    initials: 'JD',
    content:
      'They built a plan that fit my life. I felt supported every step.',
    rating: 5,
    gradient: 'from-blue-50 to-blue-100',
  ...
  },
  {
    ...
    initials: 'MT',
    content:
      'Clear guidance after my accident. Recovery was faster than I expected.',
    rating: 5,
    gradient: 'from-teal-50 to-green-100',
  ...
  },
  {
    ...
    initials: 'AL',
    content:
      'Professional and discreet care. Real results without judgment.',
    rating: 5,
    gradient: 'from-purple-50 to-pink-100',
...
export default function MedicalHealthcareSolutionsToledo() {
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text:
            'Drug rehab, weight loss programs, erectile dysfunction treatment, accident injury care, and hormone replacement therapy.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text:
            `Call ${CLINIC_PHONE_DISPLAY} or use the Contact page to request an appointment.`,
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text:
            'Yes. We tailor each plan to your history, goals, medications, and follow-up needs.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text:
            'Yes. We assess injuries, treat pain, and coordinate rehabilitation to speed recovery.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text:
            'Yes. Visits are private and solutions are evidence-based and personalized.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text:
            'Yes. We provide physician-guided weight loss with coaching and sustainable goals.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text:
            'HRT adjusts hormone levels to improve energy, focus, mood, and overall wellness.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text:
            `${CLINIC_ADDRESS}. Call ${CLINIC_PHONE_DISPLAY} for directions or scheduling.`,
        },
      },
    ],
  }
  ...
  return (
    <div className="min-h-screen">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="grid grid-cols-3 gap-6 pt-6 border-t border-gray-200">
                <div className="text-center">
                  ...
                  <div className="mt-1 font-semibold text-blue-600">Recovery & Wellness</div>
                </div>
                <div className="text-center">
                  <div className="text-sm text-gray-500">Approach</div>
                  <div className="mt-1 font-semibold text-blue-600">Personalized Plans</div>
                </div>
                <div className="text-center">
                  <div className="text-sm text-gray-500">Location</div>
                  <div className="mt-1 font-semibold text-blue-600">{CITY_REGION}</div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Evidence-based care for addiction recovery, weight loss, men’s health, injury rehabilitation,
              and hormone balance—right here in Toledo.
            </p>
          </div>
      ...
      {/* Testimonials */}
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50" aria-labelledby="testimonials">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 id="testimonials" className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4 text-center">
            Patient <span className="bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent">Reviews</span>
          </h2>
            ...
            {testimonials.map((t) => (
              ...
              >
                <div className="flex items-center mb-4">
                  <div className={`w-12 h-12 bg-gradient-to-br ${t.avatarGradient} rounded-full flex items-center justify-center mr-4 flex-shrink-0`}>
      ...
      <section className="py-16 bg-white" aria-labelledby="faqs">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 id="faqs" className="text-2xl font-bold text-gray-900 mb-6">FAQs: quick answers</h2>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-teal-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Call now or message us. We’ll help you choose the right plan and get started.
          </p>
